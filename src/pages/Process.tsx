...
const processSteps = [
  ...
  },
  {
    ...
    title: "Debrief",
    description: "We conduct a post-session debrief to confirm objectives have been achieved and to share insights and recommendations that strengthen future collaboration, ensuring the original objectives deliver lasting value.",
    color: "bg-green-500",
  },
  {
        ...
        <div className="container-custom mx-auto px-4 md:px-8">
          ...
          <div className="max-w-3xl mx-auto text-center mb-12">
            <p className="font-heading font-semibold text-lg text-foreground leading-relaxed mb-6">
              We engage with you across three distinct phases to consistently deliver value for outcomes.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 auto-rows-fr">
            <div className="flex flex-col">
              <p className="text-center font-heading text-2xl font-semibold text-primary mb-4">Design</p>
              <div className="bg-secondary rounded-2xl p-8 flex flex-col flex-1">
                ...
                <div className="text-center flex-1 flex flex-col">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Clients describe our contribution as bringing elegant simplicity to complex issues. Through clear frameworks and structured conversations, we help groups navigate complexity and align your organisation and ecosystem around a shared future.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col">
              <p className="text-center font-heading text-2xl font-semibold mb-4" style={{ color: "#EBCA52" }}>Facilitate</p>
              <div className="bg-secondary rounded-2xl p-8 flex flex-col flex-1">
                ...
                <div className="text-center flex-1 flex flex-col">
                  ...
                  <p className="text-muted-foreground text-sm">
                    With over 30 years' experience, Waterfield uses highly interactive facilitation to harness collective intelligence—creating shared, owned plans that map a clear direction for success and turn clarity into meaningful action.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col">
              <p className="text-center font-heading text-2xl font-semibold mb-4" style={{ color: "#CB4547" }}>Enable</p>
              <div className="bg-secondary rounded-2xl p-8 flex flex-col flex-1">
                ...
                <div className="text-center flex-1 flex flex-col">
                  ...
                  <p className="text-muted-foreground text-sm">
                    The action phase is where the plan meets reality. We help clients adopt an agile execution model that allows teams to quickly test their hypotheses and rapidly recalibrate based on what's working—and what's not.
                  </p>
                </div>
              </div>
            </div>
